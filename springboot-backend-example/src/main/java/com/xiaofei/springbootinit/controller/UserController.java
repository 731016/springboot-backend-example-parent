...
import com.xiaofei.springbootinit.model.dto.user.UserRegisterRequest;
import com.xiaofei.springbootinit.model.dto.user.UserUpdateMyRequest;
import com.xiaofei.springbootinit.model.dto.user.UserUpdateRequest;
import com.xiaofei.springbootinit.model.entity.User;
import com.xiaofei.springbootinit.model.vo.LoginUserVO;
import com.xiaofei.springbootinit.model.vo.UserVO;
...
import static com.xiaofei.springbootinit.service.impl.UserServiceImpl.SALT;
...
public class UserController {
    ...
    @ApiLog(value = "搜索用户")
    @GetMapping("/search")
    public BaseResponse<List<LoginUserVO>> searchUsers(String username, HttpServletRequest request) {
        ...
        List<LoginUserVO> list = userList.stream().map(user -> userService.getLoginUserVO(user)).collect(Collectors.toList());
